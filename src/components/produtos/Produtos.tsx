...
export function Produtos() {
  ...
  return (
    <section className="py-8 sm:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-x-hidden">
      <h2 className="text-3xl font-bold text-[#060E3D] mb-8 sm:mb-12 text-left sm:text-center">
